...
class JobListView(ListView):
    ...
    def get_queryset(self):
        ...
        return Job.objects.filter(author=currentuser).order_by('-apply_date', 'title', 'id')
...
class LocationListView(ListView):
    ...
    def get_queryset(self):
        ...
        currentuser = getUserorTestUser(self.request.user)
        return Job.objects.filter(city=city, state=state, author=currentuser).order_by('-apply_date', 'title', 'id')
...
class EmployerListView(ListView):
    ...
    def get_queryset(self):
        ...
        currentuser = getUserorTestUser(self.request.user)
        return Job.objects.filter(employer=employer, author=currentuser).order_by('-apply_date', 'title', 'id')
...
class StatusListView(ListView):
    ...
    def get_queryset(self):
        ...
        currentuser = getUserorTestUser(self.request.user)
        return Job.objects.filter(status=status, author=currentuser).order_by('-apply_date', 'title', 'id')
